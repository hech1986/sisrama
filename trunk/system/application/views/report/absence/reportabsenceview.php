...
<title>Rekapitulasi Ketidakhadiran</title>
<!-- #EndEditable -->
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="right" valign="center" class="submenu"><img src="images/dn_logo_smallest.gif"  align="left"><!-- #BeginEditable "judul" -->Rekapitulasi Ketidakhadiran<!-- #EndEditable --></td>
  </tr>
  <tr> 
    <td> 
      &nbsp;
<form name="rimba" enctype="multipart/form-data" method="post" action="/sisrama/reportabsence.php?action=save">
<script>
...
<option label="2009" value="2009">2009</option>
	...
	<tr>
		<td class="formcolor">Kode Absen</td>
		<td colspan=3 class="formcolor">
			<input type="hidden" name="action">
			<select name="status">
		<option></option><option label="H" value="H">H</option>
...
<option label="S" value="S">S</option>
  ...
  <tr> 
    <td align="right">
		...
		<input type="button" class="formbox" value=" Refresh " OnClick="javascript:window.location='/sisrama/reportabsence.php?'">
   ...
   <tr>
		...
		<td class="palareport" width=40%>Nama Santri</td>
		<td class="palareport" width=15%>Kelas</td>
		<td class="palareport" width=15%>Kamar</td>
		<td class="palareport" width=15%>Musyrif/ah</td>
	</tr>
