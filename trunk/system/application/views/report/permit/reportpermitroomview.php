...
<title>Rekapitulasi Perijinan Santri Per Kamar</title>
<!-- #EndEditable -->
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="right" valign="center" class="submenu"><img src="images/dn_logo_smallest.gif"  align="left"><!-- #BeginEditable "judul" -->Rekapitulasi Perijinan Santri Per Kamar<!-- #EndEditable --></td>
  </tr>
  <tr> 
    <td> 
      &nbsp;
<form name="rimba" enctype="multipart/form-data" method="post" action="/sisrama/reportpermitroom.php?action=save">
<script>
...
<option label="2009" value="2009">2009</option>
  ...
  <tr> 
    <td align="right">
		...
		<input type="button" class="formbox" value=" Refresh " OnClick="javascript:window.location='/sisrama/reportpermitroom.php?'">
...
<table width=100% cellspacing=0 cellpadding=0>
   <tr>
		<td class="palareport" width=15%  >No </td>
		<td class="palareport" width=15% >Rayon</td>
		<td class="palareport" width=15% >Kamar</td>
		<td class="palareport" width=15% >Jumlah Santri</td>
		<td class="palareport" width=15% >Ijin</td>
		<td class="palareport" width=15% >On Time</td>
		<td class="palareport" width=15% >Out Time</td>
	</tr>
	</table>
