...
<title>Daftar Santri Terlambat</title>
<!-- #EndEditable -->
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="right" valign="center" class="submenu"><img src="images/dn_logo_smallest.gif"  align="left"><!-- #BeginEditable "judul" -->Daftar Santri Terlambat<!-- #EndEditable --></td>
  </tr>
  <tr> 
    <td> 
      &nbsp;
<form name="rimba" enctype="multipart/form-data" method="post" action="/sisrama/reportpermitlate.php?action=save">
<script>
...
<option label="2009" value="2009">2009</option>
  ...
  <tr> 
    <td align="right">
		...
		<input type="button" class="formbox" value=" Refresh " OnClick="javascript:window.location='/sisrama/reportpermitlate.php?'">
...
<table width=100% cellspacing=0 cellpadding=0>
   <tr>
		<td class="palareport" width=15%  >No Induk</td>
		<td class="palareport" width=20% >Nama Santri</td>
		<td class="palareport" width=15% >Kelas</td>
		<td class="palareport" width=15% >Kamar</td>
		<td class="palareport" width=15% >No Surat</td>
		<td class="palareport" width=15% >Tujuan</td>
		<td class="palareport" width=15% >Pendamping</td>
		<td class="palareport" width=15% >Telepon</td>
		<td class="palareport" width=15% >Lama</td>
	</tr>
	</table>
