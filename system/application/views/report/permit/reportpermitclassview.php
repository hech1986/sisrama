...
<title>Rekapitulasi Perijinan Santri Per Kelas</title>
<!-- #EndEditable -->
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="right" valign="center" class="submenu"><img src="images/dn_logo_smallest.gif"  align="left"><!-- #BeginEditable "judul" -->Rekapitulasi Perijinan Santri Per Kelas<!-- #EndEditable --></td>
  </tr>
  <tr> 
    <td> 
      &nbsp;
<form name="rimba" enctype="multipart/form-data" method="post" action="/sisrama/reportpermitclass.php?action=save">
<script>
...
<option label="2009" value="2009">2009</option>
  ...
  <tr> 
    <td align="right">
		...
		<input type="button" class="formbox" value=" Refresh " OnClick="javascript:window.location='/sisrama/reportpermitclass.php?'">
