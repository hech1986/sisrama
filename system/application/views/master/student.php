...
<form name="rimba" method="post" action="/~spawn/ppia/mt_student.php?action=save">
      <!-- #BeginEditable "isi" --> 
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr> 
          <td width="32%" class="formcolor">Nomor Induk</td>
          <td width="34%" class="formcolor"> 
            <input type="text" name="regnumber" value="" size="10">
        ...
        <tr> 
          ...
          <td width="68%" class="formcolor"> 
            <input type="text" name="phonenumber"  size="16" value="">
          </td>
    ...
    <td align="right">
		...
		<input type="button" class="formbox" value=" Refresh " OnClick="javascript:window.location='/~spawn/ppia/mt_student.php?'">
